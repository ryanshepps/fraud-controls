...
class EventFeatureProvider(
    ...
    private fun amountToSenderBalanceRatio(context: ScoringContext): FeatureValue = if (context.event.senderBalanceBefore > BigDecimal.ZERO) {
    ...
    private fun number(value: BigDecimal): FeatureValue = FeatureValue.NumberValue(value.toDouble())
...
fun defaultEventFeatureProviders(): List<FeatureProvider> = listOf(
